 ...
 */
public class BatchMsgSendServiceTest extends BaseTestCase {
    @Autowired
    private BatchMsgSendService batchMsgSendService;
    ...
    public void deleteUsrManageBatchMessageWithBLOBsByIdTest() throws Exception {
        ...
        hm.put("recordId", 1);
        int i = batchMsgSendService.deleteUsrManageBatchMessageWithBLOBsById(hm);
    ...
    public void saveUserOperationTest() throws Exception {
        ...
        int i = batchMsgSendService.saveUserOperation(bloBs);
        Assert.assertTrue(i > 0);
    }
    ...
    public void getUsrManageBatchMessageByIdTest() throws Exception {
        HashMap<String, Object> hm = new HashMap<String, Object>();
        hm.put("recordId", 1);
        UsrManageBatchMessageWithBLOBs value = batchMsgSendService.getUsrManageBatchMessageById(hm);
    ...
    public void makeStandardTemplateExcelTest() throws Exception {
        XSSFWorkbook value = batchMsgSendService.makeStandardTemplateExcel();
        Assert.assertNotNull(value);
    }
    ...
    public void getUsrManageBatchMsgListTest() throws Exception {
        ...
        List<UsrManageBatchMessageWithBLOBs> list = batchMsgSendService
