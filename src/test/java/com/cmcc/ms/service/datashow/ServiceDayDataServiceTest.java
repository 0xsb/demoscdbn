 ...
 * @author zhangxu-ws
 */
public class ServiceDayDataServiceTest extends BaseTestCase {
    ...
    public void addCDNListTest() throws Exception {
        ...
        list.add(cdnDay);
        serviceDayDataService.addCDNList(list);
    }
    ...
    public void addIDCiListTest() throws Exception {
        ...
        list.add(idcDay);
        serviceDayDataService.addIDCiList(list);
    }
    ...
    public void addOTTListTest() throws Exception {
        ...
        list.add(pod);
        serviceDayDataService.addOTTList(list);
    }
    ...
    public void addProvinceCacheListTest() throws Exception {
        ...
        list.add(pcd);
        serviceDayDataService.addProvinceCacheList(list);
    }
    ...
    public void addUnfiedCacheListTest() throws Exception {
        ...
        list.add(ucd);
        serviceDayDataService.addUnfiedCacheList(list);
        ;
    }
    ...
    public void findNewCDNListTest() throws Exception {
        serviceDayDataService.findNewCDNList(new Date());
    }
    ...
    public void findNewIDCiListTest() throws Exception {
        serviceDayDataService.findNewIDCiList(new Date());
    }
    ...
    public void findNewOTTListTest() throws Exception {
        serviceDayDataService.findNewOTTList(new Date());
    }
    ...
    public void findNewProvinceCacheListTest() throws Exception {
        serviceDayDataService.findNewProvinceCacheList(new Date());
    }
    ...
    public void findNewUnfiedCacheListTest() throws Exception {
        serviceDayDataService.findNewUnfiedCacheList(new Date());
    }
    ...
    public void selectMaxCreatetimeTest() throws Exception {
        serviceDayDataService.selectMaxCreatetime();
    }
}
