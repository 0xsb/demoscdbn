 ...
 */
public class BusinessTrafficServiceImplTest extends BaseTestCase {
    @Autowired
    private BusinessTrafficServiceImpl businessTrafficServiceImpl;
    ...
    public void insertBusinessTrafficListTest() throws Exception {
        ...
        list.add(t5);
        list.add(t6);
        businessTrafficServiceImpl.insertBusinessTrafficList(list);
    }
}
