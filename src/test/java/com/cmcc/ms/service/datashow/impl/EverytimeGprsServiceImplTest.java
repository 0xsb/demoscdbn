 ...
 */
public class EverytimeGprsServiceImplTest extends BaseTestCase {

    @Autowired
    private EverytimeGprsServiceImpl everytimeGprsServiceImpl;
    ...
    public void insertEverytimeListTest() throws Exception {
        ...
        list.add(gprs);
        everytimeGprsServiceImpl.insertEverytimeList(list);
    }
    ...
    public void selectAllTest() throws Exception {
        everytimeGprsServiceImpl.selectAll();
    }
}
