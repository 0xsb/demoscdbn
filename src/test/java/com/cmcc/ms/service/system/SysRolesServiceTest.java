 ...
 * @author zhangxu-ws
 */
public class SysRolesServiceTest extends BaseTestCase {
    ...
    public void countByExampleTest() throws Exception {
        ...
        map.put("sortName", "1");
        Integer value = sysRolesService.countByExample(map);
    ...
    public void insertTest() throws Exception {
        ...
        Integer value = sysRolesService.insert(sysRoles);
        Assert.assertTrue(value > 0);
    }
    ...
    public void updateByPrimaryKeySelectiveTest() throws Exception {
        ...
        sysRoles.setCreateDate(new Date());
        sysRoles.setRoleDesc("测试");
        Integer value = sysRolesService.updateByPrimaryKeySelective(sysRoles);
        Assert.assertTrue(value > 0);
    }
    ...
    public void getSysRolesListTest() throws Exception {
        ...
        List<SysRolesManual> list = sysRolesService.getSysRolesList(map, pb);
    ...
    public void deleteRelationByRoleIdTest() throws Exception {
        Integer value = sysRolesService.deleteRelationByRoleId(2);
        Assert.assertTrue(value > 0);
    }
    ...
    public void selectByPrimaryKeyTest() throws Exception {
        SysRolesManual sysRolesManual = sysRolesService.selectByPrimaryKey(2);
    ...
    public void updatePrivilegeTest() throws Exception {
        ...
        boolean flg = sysRolesService.updatePrivilege(2, menuId);
