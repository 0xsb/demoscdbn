...
import com.cmcc.ms.entity.datashow.UnifiedCacheDayExample.Criteria;
import com.cmcc.ms.entity.datashow.UnifiedCacheDayExample.Criterion;

/**
 * @author zhangxu-ws
 */
public class UnifiedCacheDayExampleTest {
    /**
     * Run the unifiedCacheDayExample() constructor test.
     *
     * @throws Exception
     *
    ...
    @Test
    public void test() {
        UnifiedCacheDayExample unifiedCacheDayExample = new UnifiedCacheDayExample();
        Criteria createCriteria = unifiedCacheDayExample.createCriteria();
        String nu = "";
        ...
        Criterion criterion = new  com.cmcc.ms.entity.datashow.UnifiedCacheDayExample.Criterion("");
    ...
    public static void main(String[] args) {
        new org.junit.runner.JUnitCore().run(UnifiedCacheDayExampleTest.class);
    }
}
