...
import com.cmcc.ms.entity.datashow.UnifiedCacheWeekExample.Criteria;
import com.cmcc.ms.entity.datashow.UnifiedCacheWeekExample.Criterion;

/**
 *
 * @author zhangxu-ws
 */
public class UnifiedCacheWeekExampleTest {
    /**
     * Run the unifiedCacheWeekExample() constructor test.
     *
     * @throws Exception
     *
    ...
    @Test
    public void test() {
        UnifiedCacheWeekExample unifiedCacheWeekExample = new UnifiedCacheWeekExample();
        Criteria createCriteria = unifiedCacheWeekExample.createCriteria();
        String nu = "";
        ...
        Criterion criterion = new  com.cmcc.ms.entity.datashow.UnifiedCacheWeekExample.Criterion("");
    ...
    public static void main(String[] args) {
        new org.junit.runner.JUnitCore().run(UnifiedCacheWeekExampleTest.class);
    }
}
