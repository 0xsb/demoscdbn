...
import com.cmcc.ms.entity.datashow.UnifiedCdnWeekExample.Criteria;
import com.cmcc.ms.entity.datashow.UnifiedCdnWeekExample.Criterion;

/**
 * The class <code>UnifiedCdnWeekExampleTest</code> contains tests for the class <code>{@link UnifiedCdnWeekExample}</code>.
 *
 * @generatedBy CodePro at 17-9-29 上午9:43
 * @author ldy
 * @version $Revision: 1.0 $
 */
public class UnifiedCdnWeekExampleTest {
    /**
     * Run the unifiedCdnWeekExample() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 17-9-29 上午9:43
    ...
    @Test
    public void test() {
        UnifiedCdnWeekExample unifiedCdnWeekExample = new UnifiedCdnWeekExample();
        Criteria createCriteria = unifiedCdnWeekExample.createCriteria();
        String nu = "";
        ...
        Criterion criterion = new  com.cmcc.ms.entity.datashow.UnifiedCdnWeekExample.Criterion("");
    ...
    public static void main(String[] args) {
        new org.junit.runner.JUnitCore().run(UnifiedCdnWeekExampleTest.class);
    }
}
