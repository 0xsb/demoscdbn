...
import com.cmcc.ms.entity.datashow.ProvinceOttWeekExample.Criteria;
import com.cmcc.ms.entity.datashow.ProvinceOttWeekExample.Criterion;

/**
 * @author zhangxu-ws
 */
public class ProvinceOttWeekExampleTest {
    /**
     * Run the ProvinceOttWeekExample() constructor test.
     *
     * @throws Exception
     *
     */
    @Test
    public void test() {
        ProvinceOttWeekExample provinceOttWeekExample = new ProvinceOttWeekExample();
        Criteria createCriteria = provinceOttWeekExample.createCriteria();
        String nu = "";
        ...
        Criterion criterion = new  com.cmcc.ms.entity.datashow.ProvinceOttWeekExample.Criterion("");
    ...
    public static void main(String[] args) {
        new org.junit.runner.JUnitCore().run(ProvinceOttWeekExampleTest.class);
    }
}
