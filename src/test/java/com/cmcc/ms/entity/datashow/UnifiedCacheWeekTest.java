 ...
 * @author zhangxu-ws
 */
public class UnifiedCacheWeekTest {
    /**
    ...
    public void testGetCreatetime() throws Exception {
        UnifiedCacheWeek fixture = new UnifiedCacheWeek();
    ...
    public static void main(String[] args) {
        new org.junit.runner.JUnitCore().run(UnifiedCacheWeekTest.class);
    }
}
