 ...
 * @author zhangxu-ws
 */
public class UnifiedCacheDayTest {
    /**
    ...
    public void testGetCreatetimea() throws Exception {
        UnifiedCacheDay fixture = new UnifiedCacheDay();
    ...
    public static void main(String[] args) {
        new org.junit.runner.JUnitCore().run(UnifiedCacheDayTest.class);
    }
}
