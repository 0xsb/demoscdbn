...
import com.cmcc.ms.entity.datashow.ProvinceCacheDayExample.Criteria;
import com.cmcc.ms.entity.datashow.ProvinceCacheDayExample.Criterion;

/**
 *
 * @author ldy
 */
public class ProvinceCacheDayExampleTest {
    /**
     * Run the ProvinceCacheDayExample() constructor test.
     *
     * @throws Exception
     *
     */
    @Test
    public void test() {
        ProvinceCacheDayExample provinceCacheDayExample = new ProvinceCacheDayExample();
        Criteria createCriteria = provinceCacheDayExample.createCriteria();
        String nu = "";
        ...
        Criterion criterion = new  com.cmcc.ms.entity.datashow.ProvinceCacheDayExample.Criterion("");
    ...
    public static void main(String[] args) {
        new org.junit.runner.JUnitCore().run(ProvinceCacheDayExampleTest.class);
    }
}