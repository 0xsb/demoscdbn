...
import com.cmcc.ms.entity.datashow.ProvinceCacheWeekExample.Criteria;
import com.cmcc.ms.entity.datashow.ProvinceCacheWeekExample.Criterion;

/**
 * @author zhangxu-ws
 */
public class ProvinceCacheWeekExampleTest {
    /**
     * Run the ProvinceCacheWeekExample() constructor test.
     *
     * @throws Exception
     *
     */
    @Test
    public void test() {
        ProvinceCacheWeekExample provinceCacheWeekExample = new ProvinceCacheWeekExample();
        Criteria createCriteria = provinceCacheWeekExample.createCriteria();
        String nu = "";
        ...
        Criterion criterion = new  com.cmcc.ms.entity.datashow.ProvinceCacheWeekExample.Criterion("");
    ...
    public static void main(String[] args) {
        new org.junit.runner.JUnitCore().run(ProvinceCacheWeekExampleTest.class);
    }
}
