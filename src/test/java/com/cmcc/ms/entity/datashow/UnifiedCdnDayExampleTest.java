...
import com.cmcc.ms.entity.datashow.UnifiedCdnDayExample.Criteria;
import com.cmcc.ms.entity.datashow.UnifiedCdnDayExample.Criterion;

/**
 * The class <code>UnifiedCdnDayExampleTest</code> contains tests for the class <code>{@link UnifiedCdnDayExample}</code>.
 *
 * @generatedBy CodePro at 17-9-29 上午9:43
 * @author ldy
 * @version $Revision: 1.0 $
 */
public class UnifiedCdnDayExampleTest {
    /**
     * Run the unifiedCdnDayExample() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 17-9-29 上午9:43
    ...
    @Test
    public void test() {
        UnifiedCdnDayExample unifiedCdnDayExample = new UnifiedCdnDayExample();
        Criteria createCriteria = unifiedCdnDayExample.createCriteria();
        String nu = "";
        ...
        Criterion criterion = new  com.cmcc.ms.entity.datashow.UnifiedCdnDayExample.Criterion("");
    ...
    public static void main(String[] args) {
        new org.junit.runner.JUnitCore().run(UnifiedCdnDayExampleTest.class);
    }
}
