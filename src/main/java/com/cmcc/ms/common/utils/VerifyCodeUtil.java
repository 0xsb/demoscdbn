...
public class VerifyCodeUtil {
    ...
    /**
     * Instantiates a new verify code util.
     */
     ...
     * @return 图片缓存对象
     */
    public static BufferedImage generateImageCode(int type, int length, String excludeString,
                                                  int width, int height, int interLine,
        ...
        return generateImageCode(textCode, width, height, interLine, randomLocation, backColor,
                foreColor, lineColor);
    }
    ...
    public static BufferedImage generateImageCode(String textCode, int width, int height,
        ...
        // 字体大小为图片高度的80%
        int fsize = (int) (height * 0.80);
        int fx = height - fsize;
        int fy = fsize;
        // 设定字体
        graphics.setFont(new Font("Default", Font.LAYOUT_LEFT_TO_RIGHT, fsize));
        // 写验证码字符
