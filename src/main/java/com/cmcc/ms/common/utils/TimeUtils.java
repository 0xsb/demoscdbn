...
public class TimeUtils {
    ...
    /** The Constant FORMAT_DATE_TIME_SECONDS. */
    public final static String FORMAT_DATE_TIME_SECONDS = "yyyy-MM-dd hh:mm:ss";
    ...
    public static Date parseTime(String timeString) {
        try {
            String[] arr = new String[] { "hh:mm:ss", "h:m:s", "hh:mm", "h:m" };
            return DateUtils.parseDate(timeString, arr);
        } catch (ParseException e) {
            return null;
        }
    }
    ...
    /**
     * 定时任务的记录时间 yyyy-MM-dd.
     *
     * @param date the date
     * @return the string
     */
    public static String statTaskRecordTime(Date date) {
     ...
     * @return the date
     */
    public static Date statTaskRecordTimeDate(Date date) {
        SimpleDateFormat dateFormat = new SimpleDateFormat(FORMAT_DATE);
        String format = dateFormat.format(date);
        Date parse = null;
        try {
    ...
    /**
     * 报表导出 处理时间格式 timeType 时间类型:yyyy-MM-dd hh:mm:ss.
     *
     * @param obj the obj
     * @return String 格式
     */
    public static String getExportFormatTimetamp(Object obj) {
        SimpleDateFormat dateFormat = new SimpleDateFormat(TimeUtils.FORMAT_DATE_TIME_SECONDS);
        return dateFormat.format(obj);
    }

    /**
     * 根据开始时间和结束时间返回时间段内的时间集合(字符串).
     *
     * @param startTime the start time
     * @param endTime the end time
     * @return the linked list
     */
    public static LinkedList<String> timeSplit(String startTime, String endTime) {
        LinkedList<String> dateStr = new LinkedList<String>();
        ...
        List datesBetweenTwoDate = getDatesBetweenTwoDate(beginDate, endDate);
        for (int i = 0; i < datesBetweenTwoDate.size(); i++) {
            String formatDate = sdf.format(datesBetweenTwoDate.get(i));
