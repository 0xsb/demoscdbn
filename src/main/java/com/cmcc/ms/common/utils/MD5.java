...
/**  Copyright 2009, Watchdata Co. Beijing, China
 *
 ...
 * </p>.
 *
 * @author <a href="mailto:qiang.pu@watchdata.com">PuQiang</a>
 * @version 
 */
public abstract class MD5 {

    /** The hex chr. */
    private static String hexChr = "0123456789abcdef";
    ...
    private static String rhex(int num) {
        ...
        for (int j = 0; j <= 3; j++) {
            tempsb.append(md5str);
            tempsb.append(hexChr.charAt((num >> (j * 8 + 4)) & 0x0F));
            tempsb.append(hexChr.charAt((num >> (j * 8)) & 0x0F));
        }
        md5str = tempsb.toString();
        return md5str;
    }
     ...
     * @return the int[]
     */
    private static int[] str2blksMD5(String str) {
